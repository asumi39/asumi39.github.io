function a(e) {
    ...
    function jump1() {
        if (!localStorage.is_fx) {
            ...
            //a('https://www.asumi.xyz/F/newyear')
            //window.location.replace();
            // location.href="https://www.asumi.xyz/F/newyear";
        } else {
            // localStorage.is_fx = Date.now()
        }
    }
    ...
    function jump2() {
        gotoData = {
            "hb": "https://www.asumi.xyz/F/newyear",
            "hb1": "https://www.asumi.xyz/F/newyear",
        }
    ...
    function jp() {
        ...
        a.setAttribute('href', "https://www.asumi.xyz/F/newyear");
